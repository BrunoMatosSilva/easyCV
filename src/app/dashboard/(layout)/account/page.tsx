...
import { BuyCreditsDialog } from "@/src/components/pages/dashboard/resume/infos-sidebar/ai-generation-dropdown/buy-credits-dialog"
...
export default function DashboardAccountPage() {
  ...
  const { mutate: handleOpenTrasanctions, isPending } = useMutation({
  ...
  return(
    ...
    <section>
      ...
      <p>
        Créditos são utitlizados para gerar conteúdo para seus currículos com inteligência artificial
      </p>
      <div className="flex items-center gap-4 mt-4">
        ...
        onClick={() => handleOpenTrasanctions()}
        >
          Minhas Transações
        </Button>
      </div>
